...
struct HeartbeatReportTests {
    ...
    func writesMarkdownAndJSONReports() throws {
        ...
        let systemTrustRange = try #require(markdown.range(of: "| ✅ | System trust"))
        let pinnedCheckRange = try #require(markdown.range(of: "| ✅ | Example API"))
        #expect(systemTrustRange.lowerBound < pinnedCheckRange.lowerBound)
